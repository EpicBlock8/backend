...
def test_file_download(file_uuid, private_key):
    ...
    if response.status_code == 200:
        ...
        with open(TEST_FILE_PATH, "rb") as original, open(download_path, "rb") as downloaded:
            if original.read() == downloaded.read():
                print("✅ File integrity verified - original and downloaded files match!")
            else:
...
def main():
    ...
    private_key = Ed25519PrivateKey.from_private_bytes(b"test_key_32_bytes_for_demo_only!")
